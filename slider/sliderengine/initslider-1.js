jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        showfacebook:true,
        titlecss:"display:table; position:relative; font-weight:300; font-style:italic; font-size:32px; font-family:Georgia,sans-serif,Arial; color:#fff; padding:10px; margin:0px auto;text-shadow: 3px 2px rgba(0, 0, 0, 1);",
        ribbonimagey:0,
        ribbonimagex:0,
        ...
        textpositiondynamic:"topleft,bottomleft,topcenter",
        shadowsize:5,
